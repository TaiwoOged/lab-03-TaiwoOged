...
public class MainActivity extends AppCompatActivity implements AddCityFragment.AddCityDialogListener, EditCityFragment.EditCityDialogListener {
    ...
    private int selectedPosition = -1; // keeps track of selected city
    ...
    public void editCity(City newCity) {
        cityAdapter.insert(newCity, getSelectedPosition());
        cityAdapter.remove(cityAdapter.getItem(getSelectedPosition() + 1));
        cityAdapter.notifyDataSetChanged();
    }
